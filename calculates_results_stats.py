...
def calculates_results_stats(results_dic):
    ...
    """  
    #create empty dic and variables for images and labels
    ...
    #loop through keys in results_dic and add 1 to the respective label according to the key's status
    for key in results_dic :
        ...
        if results_dic[key][2] == 1 and results_dic[key][3] == 1:
            n_correct_breed += 1
    #assign images and labels variables to dictionary 
    ...
    #create percentages
    results_stats_dic['pct_match'] = (float(n_match)/n_images) * 100.0
    if n_dogs_img :
        results_stats_dic['pct_correct_dogs'] = (float(n_correct_dogs)/n_dogs_img) * 100.0
        results_stats_dic['pct_correct_breed'] = (float(n_correct_breed)/n_dogs_img) * 100.0
    else :
        results_stats_dic['pct_correct_dogs'] = 0.0
        results_stats_dic['pct_correct_breed'] = 0.0
    if n_notdogs_img :
        results_stats_dic['pct_correct_notdogs'] = (float(n_correct_notdogs)/n_notdogs_img) * 100.0
    else :
